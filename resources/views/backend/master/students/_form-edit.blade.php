{{-- Form edit satu siswa.

     Dipisahkan dari halaman daftar dan dimuat lewat AJAX saat tombol Edit
     ditekan. Sebelumnya form ini dirender untuk SETIAP siswa di halaman
     daftar: dengan 124 siswa, HTML halamannya membengkak jadi 422 KB dan
     seluruh 124 form itu tetap dikirim walau paling banyak satu yang dibuka.

     Variabel yang diharapkan: $item (Student), $schools, $waves. --}}

<!-- Edit Modal -->
<div class="modal fade drawer-modal" id="editModalIsi" tabindex="-1" aria-hidden="true">
