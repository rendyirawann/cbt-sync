...
@section('title', 'Raport Hasil Ujian Belum Tersedia')
    ...
    <div class="app-container container-xxl">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body text-center py-20">
                ...
                <h2 class="fw-extrabold text-gray-900 mb-2">Raport Hasil Ujian Belum Tersedia</h2>
                ...
                @if(!auth()->user()->hasRole('Siswa'))
                    <a href="{{ route('admin.rapor.index') }}" class="btn btn-primary fw-bold">
                        <i class="ki-outline ki-left fs-4 me-1"></i> Kembali ke Raport Hasil Ujian
                    </a>
                @endif
            </div>
        </div>
