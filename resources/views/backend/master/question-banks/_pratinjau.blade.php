{{-- CATATAN PENTING: partial ini disuntikkan lewat AJAX ke dalam elemen yang
     SUDAH .modal-content (kerangka modal di question-banks/index.blade.php).
     Jadi ia TIDAK boleh membawa pembungkus .modal / .modal-dialog /
     .modal-content sendiri: Bootstrap tetap memberi .modal{display:none} dan
     hasilnya modal bersarang yang tidak pernah tampil — panelnya terbuka,
     isinya kosong. Itu yang terjadi sejak commit 0d2153d. --}}
